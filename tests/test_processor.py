...
def test_extracao_regex_campos_corretos(mock_log_file: Path, temp_output_dirs: tuple) -> None:
...
def test_descarte_linhas_invalidas(mock_log_file: Path, temp_output_dirs: tuple) -> None:
    output, quarantine = temp_output_dirs
    result = process_logs(mock_log_file, output, quarantine)
...
def test_quarantine_tem_rejection_reason(mock_log_file: Path, temp_output_dirs: tuple) -> None:
    output, quarantine = temp_output_dirs
    result = process_logs(mock_log_file, output, quarantine)
